...
- 状态：P0/P1 产品实现历史 checkpoint 已验证；当前 RC 离线门禁全绿，Git release baseline 的 review 01 修复等待独立复审
- 日期：2026-07-24
...
- 发布状态：`release-baseline-001` 仍为 `in-progress`；独立 review 01 因 Node pin 不一致而
  blocked，当前修复等待独立复审，尚未创建 `p0-p1-mvp` tag
